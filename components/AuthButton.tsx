...
export default function AuthButton() {
  ...
  // Still resolving auth state — show a neutral placeholder, never the sign-in button.
  // This prevents triggering a new Google OAuth while a session is loading.
  if (isLoading) {
    return (
  ...
  // Logged in — show avatar + portal dropdown
  return (
