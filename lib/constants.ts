...
const SERVICES_EN: Service[] = [
  ...
  },
  {
    ...
    imageSrc: '/images/arnaud-squat.jpg',
    ...
    detail: {
      heroImageSrc: '/images/arnaud-squat.jpg',
...
const PROGRAMS_FR: Program[] = [
  ...
  },
  {
    ...
    goals: [
      ...
      'Devenir indépendant grâce à de nouvelles connaissances et à vos progrès techniques et physiques',
...
const PROGRAMS_EN: Program[] = [
  ...
  },
  {
    ...
    goals: [
      ...
      'Become independent through new knowledge and your technical and physical progress',
