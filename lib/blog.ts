...
export const BLOG_POSTS: BlogPost[] = [
  ...
  },
  {
    ...
    contentEn: [
      "If you are torn between training at a gym or outdoors, this article is for you. As a sports coach in Valbonne, I offer both formats, but I consistently see that clients who train outside achieve better results and stay motivated longer. Here is why.",
  ...
  },
  {
    ...
    imageAltEn: 'Balanced meal with proteins, vegetables and complex carbohydrates',
    content: [
    ...
    contentEn: [
      ...
      "My nutritional approach as a coach in Valbonne is pragmatic: no strict diets, no absolute bans, but a progressive and personalized rebalancing. The goal is to give you the knowledge and habits to manage your diet autonomously and sustainably. This is what distinguishes a temporary change from a true long-term transformation.",
    ],
  },
  {
    ...
    contentEn: [
      "It is never too late to start or return to physical activity. At 40, 50 or even 60, sport can transform your quality of life. As a sports coach in Valbonne, I work with many clients in this age group, and the results are always remarkable. Here is how to approach returning to sport safely.",
      ...
      "The role of a sports coach is particularly valuable in this situation. They adapt every exercise to your fitness level, correct your posture to prevent injury, and keep you motivated over the long term. In Valbonne, I offer individual sessions perfectly tailored to the specific needs of people over 40. Contact me for a personalized assessment.",
    ],
  },
  {
    ...
    titleEn: 'Sport and Mental Health: How Physical Activity Transforms Your Well-being',
    description:
  ...
  },
  {
    ...
    contentEn: [
      "Stress and anxiety are part of modern life, but when they become chronic, they can seriously affect your physical and mental health. As a sports coach in Valbonne, I regularly work with clients who arrive at their first session with high stress levels. The good news? There are simple, accessible techniques to regain control.",
  ...
  },
  {
    ...
    imageAltEn: 'Person walking on a sunny path, symbolizing the return of motivation',
    content: [
